...
<div class="profile-header">
    ...
    <div class="profile-action-group">
        <a href="{{ route('visits', ['patient_id' => $patient->id, 'open_modal' => 1]) }}" class="btn-profile-action btn-profile-primary">
        ...
        <div class="info-card">
            ...
            @if($visits->count() > 0)
                ...
                <div class="visit-card">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
                        ...
                        <button type="button" class="btn-icon" onclick="showVisitDetail({{ $visit->id }})" style="padding: 6px 12px; background: var(--primary);">
            ...
            @else
                <div style="text-align: center; padding: 60px;">
                    ...
                    <a href="{{ route('visits', ['patient_id' => $patient->id, 'open_modal' => 1]) }}" class="btn-primary" style="margin-top: 15px;">
