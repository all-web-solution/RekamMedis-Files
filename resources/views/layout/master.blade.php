...
<head>
    ...
    <title>Aplikasi Klinik Sehat</title>
    ...
    <style>
        ...
        * {
        ...
        /* Buttons */
        .btn-icon, .btn-primary, .btn-secondary, .btn-warning, .btn-danger {
            padding: 10px 20px;
            border: none;
            border-radius: 12px;
            cursor: pointer;
        ...
        .btn-icon:hover, .btn-primary:hover, .btn-warning:hover, .btn-danger:hover {
